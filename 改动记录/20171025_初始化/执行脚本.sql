...
--4、定义工作流程名称 ，步骤等
  ...
  select v_EntGid, v_ModelGid, v_ModelCode, '报销申请流程', 3, '养老', '1.0', 0, 0 from dual;
...
--6、定义工作流程步骤走向
  ...
  insert into WF_Task_Define_Condition(EntGid, ModelGid, FromTaskDef, ToTaskDef)
  select v_EntGid, v_ModelGid, v_TaskGid_T2, v_TaskGid_T4 from dual;
...
--4、定义工作流程名称 ，步骤等
  insert into WF_Model(EntGid, ModelGid, Code, Name, STAT, CLASSIFY, VERSION, AP1, AP2)
  select v_EntGid, v_ModelGid, v_ModelCode, '出差申请流程', 3, '养老', '1.0', 0, 0 from dual;
...
--4、定义工作流程名称 ，步骤等
  insert into WF_Model(EntGid, ModelGid, Code, Name, STAT, CLASSIFY, VERSION, AP1, AP2)
  select v_EntGid, v_ModelGid, v_ModelCode, '费用申请流程', 3, '养老', '1.0', 0, 0 from dual;
...
--4、定义工作流程名称 ，步骤等
  insert into WF_Model(EntGid, ModelGid, Code, Name, STAT, CLASSIFY, VERSION, AP1, AP2)
  select v_EntGid, v_ModelGid, v_ModelCode, '付款申请流程', 3, '养老', '1.0', 0, 0 from dual;
