create or replace procedure P_PrlYL_Stamp_doApp(p_EntGid    varchar2, --企业Gid
...
--4、定义工作流程名称 ，步骤等
  ...
  select v_EntGid, v_ModelGid, v_ModelCode, '物资采购流程', 3, '人寿堂', '1.0', 0, 0 from dual;
...
create or replace procedure P_PrlYL_CG_doApp(p_EntGid    varchar2, --企业Gid
                                                p_ModelGid  varchar, --模型Gid
                                                p_FlowGid   varchar, --流程Gid
                                                p_AppAssign varchar2 --意见
                                                ) as
...
/
create or replace procedure P_PrlYL_CG_doMail(p_FlowGid varchar --流程Gid
                                              ) as
  v_Stage   varchar2(1024); -- 过程场景
  v_ErrText varchar2(1024); -- Oracle错误信息
